...
async function tryAtMost(userPromise, maxRetries = 3, retryInterval = 60000, _tempPromiseDeferred) {
  ...
  Object.defineProperty(global, 'device', {
    ...
    set(originalDevice) {
      ...
      originalDevice.launchApp = async options => {
        ...
        const result = await tryAtMost(detoxOriginalLaunchApp(options), 3, 60000);
